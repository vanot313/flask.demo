...
base_verify1 = pd.read_csv('datasets/base_verify1.csv', engine='python', encoding="gbk")
knowledge_verify1 = pd.read_csv('datasets/paient_information_verify1.csv', engine='python', encoding="gbk")
money_verify1 = pd.read_csv('datasets/money_information_verify1.csv', engine='python', encoding="gbk")
year_verify1 = pd.read_csv('datasets/year_report_verify1.csv', engine='python', encoding="gbk")
